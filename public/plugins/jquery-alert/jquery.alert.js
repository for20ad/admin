...
(function($){
	...
	jQuery.extend({
		  ...
		  confirmx: function(title,msg,yesCallback,cancleCallback) {
			  ...
			  var options = {
				  'title':title,
				  'content':'<div class="form-list"><br><p class="center">'+msg+'</p><br><br><div class="center"><a class="btn btn-blue js-yes-btn" href="javascript:void(0);">Okey</a><a class="btn btn-gray btn-h30 js-cancle-btn" href="javascript:void(0);">Cancel</a></div><br /></div>',
				  'ctnWrapClass':'elastic-pupop-sl'
			  };
