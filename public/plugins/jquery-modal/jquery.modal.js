...
function modal(e) {
	...
	e.cModal = function(t) {
		var n = {
				...
				_classes: {
					box: "#modal-window .modal-box",
					boxInner: "#modal-window .modal-inner",
					title: "#modal-window .modal-title",
					content: "#modal-window .modal-text",
					buttons: "#modal-window .modal-buttons",
					closebtn: "#modal-window .modal-close-btn"
				}
			},
			t = e.extend({}, n, t),
