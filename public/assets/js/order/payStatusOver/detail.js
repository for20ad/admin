...
function frmModify(){
    ...
    $('#frm_modify [name=i_content]').val( editorInstances['contents_editor'].getMarkdown() );
    $('#frm_modify [name=i_answer]').val( editorInstances['answer_editor'].getMarkdown() );
    ...
    $.ajax({
        url: '/apis/board/postsDetailProc',
        method: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
