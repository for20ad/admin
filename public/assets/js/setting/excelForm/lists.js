...
function deleteFormsConfirm(f_idx){
    box_confirm('양식을 삭제하시겠습니까?', 'q', '', deleteForms, f_idx);
}

function deleteForms( f_idx ){
    const frm = $('#frm_lists')
    $.ajax({
        url: '/apis/setting/deleteForms',
        type: 'post',
        data: 'f_idx='+f_idx,
        dataType: 'json',
        cache: false,
