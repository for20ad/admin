function getSearchList( page ) {
    ...
    $.ajax({
        url: '/apis/design/getBannerLists',
        method: 'POST',
        data: frm.serialize(),
        dataType: 'json',
        cache: false,
...
function deleteBannerConfirm(i_idx){
    box_confirm('배너를 삭제하시겠습니까?', 'q', '', deleteBanner, i_idx);
}

function deleteBanner( i_idx ){
    const frm = $('#frm_lists')
    $.ajax({
        url: '/apis/design/deleteBanner',
        type: 'post',
        data: 'i_idx='+i_idx,
        dataType: 'json',
        cache: false,
