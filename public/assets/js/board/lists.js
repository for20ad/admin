...
function deleteBoardConfirm(i_idx){
    box_confirm('게시판을 삭제하시겠습니까?', 'q', '', deleteBoard, i_idx);
}

function deleteBoard( i_idx ){
    const frm = $('#frm_lists')
    $.ajax({
        url: '/apis/board/deleteBoard',
        type: 'post',
        data: 'i_idx='+i_idx,
        dataType: 'json',
        cache: false,
