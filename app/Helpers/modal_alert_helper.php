<?php
/**
 * @File   : modal_alert_helper.php
 * @Date   : 2024-04-02 18:09:30
 * @Desc   : 자바스크립트 modal alert
*/
// -----------------------------------------------------------------------------
// Alert 스크립트 헤더
// -----------------------------------------------------------------------------
    ...
    function box_alert_header()
    {
        echo '
            ...
            <head>
                ...
                <link href="/plugins/jquery-modal/jquery.modal.min.css" type="text/css" rel="stylesheet" />
...
if (! function_exists('box_alert_init')) {
    ...
    {
        echo '
            <script src="/plugins/jquery-modal/box_alert.js"></script>
        ';
    }
}
