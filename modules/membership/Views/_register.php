            ...
            <div class="card-body">
                <div class="input-group required">
                    ...
                    <input type="text" class="form-control" name="i_user_id" id="i_user_id"
                        placeholder="아이디를 입력해주세요." onblur="dupCheckId( $(this) );" value=""/>
                </div>
                <div class="input-group required">
                    <label class="label body2-c">
                        비밀번호
        ...
        <div class="card">
            ...
            <div class="card-body" >
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="i_mb_com_addr_sub" id="i_mb_com_addr_sub" value="" placeholder="상세주소 입력"/>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" style="width:1.8rem" name="i_zip_cd" id="i_zip_cd" value="" onclick="execDaumPostcode('i_zip_cd', 'i_addr')" readonly />&nbsp;&nbsp;
                    <input type="text" class="form-control" name="i_addr" id="i_addr" value=""  placeholder="주소검색시 자동입력" onclick="execDaumPostcode('i_zip_cd', 'i_addr')" readonly/>
                </div>
                <div class="input-group">
                    <label class="label body2-c">
                    </label>
                    <input type="text" class="form-control" name="i_addr_sub" id="i_addr_sub" value="" placeholder="상세주소 입력"/>
                </div>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="i_mb_height" id="i_mb_height" style="max-width:3.8rem" value=""/>
                    <span class="wordCount input-group-text"
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="i_mb_weight" id="i_mb_weight" style="max-width:3.8rem" value="" />
                    <span class="wordCount input-group-text"
                        style="border-top-left-radius:0px; border-bottom-left-radius: 0px;width:3.2rem;text-align:center">
                        kg
                    </span>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="i_mb_foot_size" id="i_mb_foot_size" style="max-width:3.8rem" value="" />
                    <span class="wordCount input-group-text"
                        style="border-top-left-radius:0px; border-bottom-left-radius: 0px;width:3.2rem;text-align:center">
                        mm
                    </span>
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" name="i_mb_waist" id="i_mb_waist" style="max-width:3.8rem" value="" />
                    <span class="wordCount input-group-text"
                        style="border-top-left-radius:0px; border-bottom-left-radius: 0px;width:3.2rem;text-align:center">
                        in
                    </span>
                ...
                <div class="input-group">
                    ...
                    <textarea name="i_mb_adm_memo" class="form-control"></textarea>
                </div>
