<?php
    ...
    $mMbIdx           = _elm($view_datas, 'o_mb_idx', 0 );
    $aOrderStatus     = _elm($view_datas, 'orderStatus', [] );
?>
<div class="row row-deck row-cards col-12"  style="padding-left:0.8rem">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body" >
                <?php echo form_open('', ['method' => 'post', 'class' => '', 'id' => 'frm_order_search', 'onSubmit' => 'return false;', 'autocomplete' => 'off']); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter">
                        <tbody>
                            ...
                            <tr>
                                <th class="no-border-bottom">주문일</th>
                                <td class="no-border-bottom">
                                    <div class="form-inline">
                ...
                <?php
                    echo getIconButton([
                        ...
                        'height' => '20',
                        'extra' => [
                            'onclick' => 'document.getElementById("frm_order_search").reset()',
                        ]
                    ]);
                ?>
                </div>
    ...
    <div class="col-12">
        <div class="card" style="border:0 !important" id="orderListsTableWrap">
            <div class="card-body" style="padding:0px !important;">
                <!-- 테이블 -->
                <div style="border:1px solid #E6E7E9; border-radius:0 0 4px 4px;">
                    <div class="table-responsive">
                        <table class="table table-vcenter" id="orderListsTable">
                            <colgroup>
                                <col style="width:5%;">
                                <col style="width:15%;">
                                <col style="width:15%">
...
<script>
    ...
    function setPeriodDate(period) {
        ...
        // 날짜 필드 업데이트
        $('#frm_order_search [name=s_start_date]').val(formatDate(startDate));
        $('#frm_order_search [name=s_end_date]').val(formatDate(endDate));
    }
