                        ...
                        <table class="table table-vcenter">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="no-border-bottom">
                                        <input type="text" class="form-control" style="width:56.2rem" name="s_title" id="s_title">
                                    </td>
                                </tr>
...
<!-- Modal E-->
<script>
function openLayer( boardIdx, id ){
    let data = '';
    let url  = '/apis/board/boardRegister';

    if( boardIdx != '' ){
        data = 'board_idx='+boardIdx;
        url  = '/apis/board/boardDetail';
    }
    $.ajax({
        url: url,
        type: 'post',
...
<?php
$owensView->setFooterJs('/assets/js/board/lists.js');
$owensView->setFooterJs('/assets/js/board/register.js');
$owensView->setFooterJs('/assets/js/board/detail.js');
