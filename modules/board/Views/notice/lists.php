...
<script>
var contents_editor = '';
function openLayer( noticeIdx, id ){
    let data = '';
    let url  = '/apis/board/noticeRegister';
    var editor_id = 'contents_editor';

    if( noticeIdx != '' ){
        data = 'n_idx='+noticeIdx;
        url  = '/apis/board/noticeDetail';
    }
    $.ajax({
        url: url,
        type: 'post',
    ...
    function initializeToastUIEditor( $id ) {
        ...
        contents_editor = new toastui.Editor({
...
<?php
$owensView->setFooterJs('/assets/js/board/notice/lists.js');
$owensView->setFooterJs('/assets/js/board/notice/register.js');
$owensView->setFooterJs('/assets/js/board/notice/detail.js');
