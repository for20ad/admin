...
?>
<div class="text-box">
    <span class="text-content"><?php echo _elm( $vData, 'G_NAME' )?></span>
    <span class="delete-box-button" onclick="deleteProductTmpLists( $(this), 'excp_product', '<?php echo _elm( $vData, 'G_IDX' )?>' )">
