            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="input-group required">
                        ...
                        <input type="text" class="form-control" name="i_coupon_name" id="i_coupon_name" data-max-length="20" data-required='쿠폰명을 입력하세요.' value="<?php echo _elm( $aData, 'C_NAME' )?>"
                        ...
                        <span class="wordCount input-group-text"
                            ...
                            <?php echo mb_strlen( _elm( $aData, 'C_NAME' ) )?>/20
                        </span>
                    </div>
                    ...
                    <div class="input-group required">
                        ...
                        <input type="text" class="form-control" name="i_coupon_discription" id="i_coupon_discription" data-max-length="20" data-required='쿠폰설명을 입력하세요.' value="<?php echo _elm( $aData, 'C_DISCRIPTION' )?>"
                            style="border-top-right-radius:0px; border-bottom-right-radius: 0px" value=""/>
                        <span class="wordCount input-group-text"
                            style="border-top-left-radius:0px; border-bottom-left-radi us: 0px">
                            <?php echo mb_strlen( _elm( $aData, 'C_DISCRIPTION' ) )?>/20
                        </span>
                    </div>
                    ...
                    <div id="group-P" style="<?php echo _elm( $aData, 'C_PUB_GBN' ) != 'P'? 'display:none':'' ?>">
                        <div class="input-group">
                            <label class="label body2-c">
                                발급대상
                                <?php
                            ...
                            <div class="form-inline">
                                <?php
                                    ...
                                    _elm( $aData, 'C_PUB_GBN' ) != 'P' ? $extras+=['disabled'=>'true']:'';
                                    $selected = _elm( $aData, 'C_PUB_GBN' ) == 'P' ? _elm( $aData, 'C_TARGET' ): '';
                                    echo form_dropdown('i_target', $options, $selected, $extras);
                                ?>
                                &nbsp;&nbsp;&nbsp;
                                <?php
                                    $options  = $aMemberGrade;
                                    $extras   = ['id' => 'i_mb_grade', 'class' => 'form-select', ];
                                    $style    = ['max-width: 174px'];
                                    if( _elm( $aData, 'C_PUB_GBN' ) != 'P' ){
                                        $extras+=[ 'disabled'=>'true'];
                                    }
                                    _elm( $aData, 'C_TARGET' ) == 'all' ? $style[] = 'display:none' : '';
                                    $extras+=[ 'style'=> join(';',$style) ];
                                    $selected =  _elm( $aData, 'C_PUB_GBN' ) == 'P' ? _elm( $aData, 'C_TARGET_GRADE_IDX' ):'';
                    ...
                    <div id="group-D" style="<?php echo _elm( $aData, 'C_PUB_GBN' ) != 'D'? 'display:none':'' ?>">
                        <div class="input-group">
                            <label class="label body2-c">
                                발급대상
                                <?php
                            ...
                            <div class="form-inline">
                                <?php
                                    $options  = ['all'=>'전체회원', 'grade'=>'지정등급'];
                                    $extras   = ['id' => 'i_target', 'class' => 'form-select', 'style' => 'width: 174px;max-width: 174px', 'onchange'=>'$(this).val() == \'grade\' ? $(\'#group-D #i_mb_grade\').show(): $(\'#group-D #i_mb_grade\').hide()'];
                                    _elm( $aData, 'C_PUB_GBN' ) != 'D' ? $extras+=['disabled'=>'true']:'';
                                    $selected = _elm( $aData, 'C_PUB_GBN' ) == 'D' ? _elm( $aData, 'C_TARGET' ) : '';
                                    echo form_dropdown('i_target', $options, $selected, $extras);
                                ?>
                                &nbsp;&nbsp;&nbsp;
                                <?php
                                    ...
                                    _elm( $aData, 'C_PUB_GBN' ) != 'D' ? $extras+=['disabled'=>'true']:'';
                                    $selected =  _elm( $aData, 'C_PUB_GBN' ) == 'D' ? _elm( $aData, 'C_TARGET_GRADE_IDX' ):'';
                                    echo form_dropdown('i_mb_grade', $options, $selected, $extras);
                                ?>
                            </div>
                        </div>
                        <div class="input-group">
                            ...
                            <div class="form-inline">
                                <input type="text" class="form-control" style="text-align:right" name="i_issue_cnt" value="<?php echo _elm( $aData, 'C_ISSUE_LIMIT' )?>" <?php echo  _elm( $aData, 'C_PUB_GBN' ) != 'D' ? 'disabled=true' : '' ?>> 개
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <?php
                                    $checked = false;
                                    if( _elm( $aData, 'C_ISSUE_NO_LIMIT_FLAG' ) == 'Y' ){
                                        $checked = true;
                                    }
                                    $setParam = [
                                    ...
                                    _elm( $aData, 'C_PUB_GBN' ) != 'D' ? $setParam['extraAttributes']+=['disabled'=>'true'] : '';
                    ...
                    <div id="group-A" style="<?php echo _elm( $aData, 'C_PUB_GBN' ) != 'A'? 'display:none':'' ?>">
                        <div class="input-group">
                            <label class="label body2-c">
                                발급대상
                                <?php
                            ...
                            <div class="form-inline">
                                <?php
                                    ...
                                    $extras   = ['id' => 'i_target', 'class' => 'form-select', 'style' => 'width:174px;max-width: 174px',];
                                    _elm( $aData, 'C_PUB_GBN' ) != 'A' ? $extras+=['disabled'=>'true']:'';
                                    $selected = _elm( $aData, 'C_TARGET' );
                                    echo form_dropdown('i_target', $options, $selected, $extras);
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="input-group">
                        ...
                        <?php
                            ...
                            $selected = _elm( $aData, 'C_NOTI_FLAG' );
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="input-group required">
                        ...
                        <div class="form-inline">
                            <?php
                                ...
                                $selected = _elm( $aData, 'C_BENEFIT_GBN' );
                                echo form_dropdown('i_benefit_gbn', $options, $selected, $extras);
                            ?>
                            &nbsp;&nbsp;&nbsp;
                            <input type="text" class="form-control" name="i_benefit" style="text-align:right;max-width:90px" numberwithcomma value="<?php echo number_format( _elm( $aData, 'C_BENEFIT' ) )?>"  data-required='금액 또는 퍼센트를 입력하세요.' >
                            <?php
                                $options  = ['won'=>'원', 'per'=>'%'];
                                $extras   = ['id' => 'i_benefit_unit', 'class' => 'form-select', 'style' => 'max-width: 90px',];
                                $selected = _elm( $aData, 'C_BENEFIT_UNIT' );
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-inline">
                            <input type="text" class="form-control" name="i_min_price" style="text-align:right" numberwithcomma value="<?php echo number_format( _elm( $aData, 'C_MIN_PRICE' ) )?>" placeholder="0"> 원
                        </div>
                    </div>

                    <div id="selectScope"  <?php echo _elm( $aData, 'C_PUB_GBN' ) == 'P' && _elm( $aData, 'C_IS_SUPER_FLAG' ) == 'Y' ? 'style="display:none"':'' ?>>
                        <div class="input-group">
                            <label class="label body2-c">
                                쿠폰 적용 범위
                                <?php
                            ...
                            <?php
                                ...
                                $selected = _elm( $aData, 'C_SCOPE_GBN' );
                                echo form_dropdown('i_scope_gbn', $options, $selected, $extras);
                            ?>
                        </div>

                        <div id="scope_all" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) != 'all' ? 'display:none':'' ?>">
                            <div class="input-group">
                                <label class="label body2-c">
                                    사용 제외 상품
                                    <?php
                            ...
                            <div class="input-group" style="max-width:90%">
                                <div id="exceptProductTxt" class="text-box-container">
                                <?php
                                    if( _elm( $aData, 'C_SCOPE_GBN' ) === 'all' && !empty( _elm( $aData, 'exceptProductLists' ) ) ){
                                        foreach( _elm( $aData, 'exceptProductLists' ) as $pKey => $items ){
                                    ?>
                                        <div class="text-box">
                                            <span class="text-content"><?php echo _elm( $items, 'G_NAME' )?></span>
                                            <span class="delete-box-button" onclick="deleteProductTmpLists( $(this), 'category', '<?php echo _elm( $items, 'G_IDX' )?>' )">
                                                <svg class="tabler-icon-circle-x" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path d="M8 8L12 12L8 8ZM12 8L8 12L12 8Z" fill="white"></path>
                                                    <path d="M8 8L12 12M12 8L8 12M1 10C1 11.1819 1.23279 12.3522 1.68508 13.4442C2.13738 14.5361 2.80031 15.5282 3.63604 16.364C4.47177 17.1997 5.46392 17.8626 6.55585 18.3149C7.64778 18.7672 8.8181 19 10 19C11.1819 19 12.3522 18.7672 13.4442 18.3149C14.5361 17.8626 15.5282 17.1997 16.364 16.364C17.1997 15.5282 17.8626 14.5361 18.3149 13.4442C18.7672 12.3522 19 11.1819 19 10C19 8.8181 18.7672 7.64778 18.3149 6.55585C17.8626 5.46392 17.1997 4.47177 16.364 3.63604C15.5282 2.80031 14.5361 2.13738 13.4442 1.68508C12.3522 1.23279 11.1819 1 10 1C8.8181 1 7.64778 1.23279 6.55585 1.68508C5.46392 2.13738 4.47177 2.80031 3.63604 3.63604C2.80031 4.47177 2.13738 5.46392 1.68508 6.55585C1.23279 7.64778 1 8.8181 1 10Z" stroke="#616876" stroke-linecap="round" stroke-linejoin="round"></path>
                                                </svg>
                                            </span>
                                        </div>
                                <?php
                        ...
                        <div id="scope_category" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) != 'category' ? 'display:none':'' ?>">
                            <div class="input-group">
                                <label class="label body2-c">
                                    카테고리 지정
                                    <span>*</span>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div style="position:relative; width:320px;">
                                        <div id="dropdown-layer-category" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) === 'category' ? 'display:none;':'' ?>max-width:280px;max-height:480px;overflow-y:auto;position:absolute;top:-450px;left:30px" class="dropdown-layer" style="">
                            ...
                            <div class="input-group">
                                ...
                                <?php
                                    if( _elm( $aData, 'C_SCOPE_GBN' ) === 'category' && !empty( _elm( $aData, 'pickItemLists' ) ) ){
                                        foreach( _elm( $aData, 'pickItemLists' ) as $pKey => $items ){
                                    ?>
                                        <div class="text-box">
                                            <span class="text-content"><?php echo _elm( $items, 'C_CATE_NAME' )?></span>
                                            <span class="delete-box-button" onclick="deleteProductTmpLists( $(this), 'category', '<?php echo _elm( $items, 'C_IDX' )?>' )">
                                                <svg class="tabler-icon-circle-x" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 10C1 11.1819 1.23279 12.3522 1.68508 13.4442C2.13738 14.5361 2.80031 15.5282 3.63604 16.364C4.47177 17.1997 5.46392 17.8626 6.55585 18.3149C7.64778 18.7672 8.8181 19 10 19C11.1819 19 12.3522 18.7672 13.4442 18.3149C14.5361 17.8626 15.5282 17.1997 16.364 16.364C17.1997 15.5282 17.8626 14.5361 18.3149 13.4442C18.7672 12.3522 19 11.1819 19 10C19 8.8181 18.7672 7.64778 18.3149 6.55585C17.8626 5.46392 17.1997 4.47177 16.364 3.63604C15.5282 2.80031 14.5361 2.13738 13.4442 1.68508C12.3522 1.23279 11.1819 1 10 1C8.8181 1 7.64778 1.23279 6.55585 1.68508C5.46392 2.13738 4.47177 2.80031 3.63604 3.63604C2.80031 4.47177 2.13738 5.46392 1.68508 6.55585C1.23279 7.64778 1 8.8181 1 10Z" fill="white"></path>
                                                    <path d="M8 8L12 12L8 8ZM12 8L8 12L12 8Z" fill="white"></path>
                                                    <path d="M8 8L12 12M12 8L8 12M1 10C1 11.1819 1.23279 12.3522 1.68508 13.4442C2.13738 14.5361 2.80031 15.5282 3.63604 16.364C4.47177 17.1997 5.46392 17.8626 6.55585 18.3149C7.64778 18.7672 8.8181 19 10 19C11.1819 19 12.3522 18.7672 13.4442 18.3149C14.5361 17.8626 15.5282 17.1997 16.364 16.364C17.1997 15.5282 17.8626 14.5361 18.3149 13.4442C18.7672 12.3522 19 11.1819 19 10C19 8.8181 18.7672 7.64778 18.3149 6.55585C17.8626 5.46392 17.1997 4.47177 16.364 3.63604C15.5282 2.80031 14.5361 2.13738 13.4442 1.68508C12.3522 1.23279 11.1819 1 10 1C8.8181 1 7.64778 1.23279 6.55585 1.68508C5.46392 2.13738 4.47177 2.80031 3.63604 3.63604C2.80031 4.47177 2.13738 5.46392 1.68508 6.55585C1.23279 7.64778 1 8.8181 1 10Z" stroke="#616876" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div id="scope_brand" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) != 'brand' ? 'display:none':'' ?>">
                            <div class="input-group">
                                <label class="label body2-c">
                                    브랜드 지정
                                </label>
                                <div class="form-inline">
                                    ...
                                    <div style="position:relative; width:460px;">
                                        <div id="dropdown-layer-brand" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) === 'brand' ? 'display:none;':'' ?>max-width:440px;position:absolute;top:-450px;left:30px" class="dropdown-layer" style="">
                            ...
                            <div class="input-group">
                                ...
                                <?php
                                    if( _elm( $aData, 'C_SCOPE_GBN' ) === 'brand' && !empty( _elm( $aData, 'pickItemLists' ) ) ){
                                        foreach( _elm( $aData, 'pickItemLists' ) as $pKey => $items ){
                                    ?>
                                        <div class="text-box">
                                            <span class="text-content"><?php echo _elm( $items, 'C_BRAND_NAME' )?></span>
                                            <span class="delete-box-button" onclick="deleteProductTmpLists( $(this), 'category', '<?php echo _elm( $items, 'C_IDX' )?>' )">
                                                <svg class="tabler-icon-circle-x" width="15" height="15" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 10C1 11.1819 1.23279 12.3522 1.68508 13.4442C2.13738 14.5361 2.80031 15.5282 3.63604 16.364C4.47177 17.1997 5.46392 17.8626 6.55585 18.3149C7.64778 18.7672 8.8181 19 10 19C11.1819 19 12.3522 18.7672 13.4442 18.3149C14.5361 17.8626 15.5282 17.1997 16.364 16.364C17.1997 15.5282 17.8626 14.5361 18.3149 13.4442C18.7672 12.3522 19 11.1819 19 10C19 8.8181 18.7672 7.64778 18.3149 6.55585C17.8626 5.46392 17.1997 4.47177 16.364 3.63604C15.5282 2.80031 14.5361 2.13738 13.4442 1.68508C12.3522 1.23279 11.1819 1 10 1C8.8181 1 7.64778 1.23279 6.55585 1.68508C5.46392 2.13738 4.47177 2.80031 3.63604 3.63604C2.80031 4.47177 2.13738 5.46392 1.68508 6.55585C1.23279 7.64778 1 8.8181 1 10Z" fill="white"></path>
                                                    <path d="M8 8L12 12L8 8ZM12 8L8 12L12 8Z" fill="white"></path>
                        ...
                        <div id="scope_product" style="<?php echo _elm( $aData, 'C_SCOPE_GBN' ) != 'product' ? 'display:none':'' ?>">
                            <div class="input-group">
                                <label class="label body2-c">
                                    상품 지정
                                    <span>*</span>
                                ...
                                <div class="form-inline">
                                    ...
                                    <?php
                                        $pickItemcount = 0;
                                        if( _elm( $aData, 'C_SCOPE_GBN' ) === 'product' && !empty( _elm( $aData, 'pickItemLists' ) ) ){
                                            $pickItemcount = count( _elm( $aData, 'pickItemLists' ) );
                                        }

                                        echo getButton([
                                            'text' => '선택 상품 보기 (' .$pickItemcount. ')',
                                            'class' => 'btn',
                                            'style' => 'width: 180px; height: 36px;'.$pickItemcount > 0 ? '': 'display:none',
                                            'extra' => [
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-inline">
                            <div id="date_type_A"  style="<?php echo _elm( $aData, 'C_PUB_GBN' ) == 'A' ? 'display:none;': '' ?>" class="form-inline">
                                <div class="input-icon">
                                    <input type="text" class="form-control datepicker-icon"
                                    name="i_period_start_date" readonly data-org_value='<?php echo _elm( $aData, 'C_PERIOD_START_AT' )?>'
                                    value="<?php echo _elm( $aData, 'C_PERIDO_LIMIT' ) == 'Y' ? _elm( $aData, 'C_PERIOD_START_AT' ) : '' ?>" >
                                ...
                                <div class="input-icon">
                                    <input type="text" class="form-control datepicker-icon"
                                        name="i_period_end_date" readonly data-org_value='<?php echo _elm( $aData, 'C_PERIOD_START_AT' )?>'
                                        value="<?php echo _elm( $aData, 'C_PERIDO_LIMIT' ) == 'Y' ? _elm( $aData, 'C_PERIOD_END_AT' ) : '' ?>">
                                    <span class="input-icon-addon">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                            height="24" viewBox="0 0 24 24" stroke-width="2"
                                            stroke="currentColor" fill="none" stroke-linecap="round"
                            ...
                            <div id="date_type_B" style="<?php echo _elm( $aData, 'C_PUB_GBN' ) != 'A' ? 'display:none;': '' ?>" class="form-inline">
                                발행일로 부터 &nbsp;&nbsp;&nbsp;
                                <?php
                                    ...
                                    _elm( $aData, 'C_PUB_GBN' ) != 'A' ? $extras+=['disabled'=>'true']:'';
                                    $selected = _elm( $aData, 'C_EXPIRE_MONTH' );
                            ...
                            <?php
                                $checked = false;
                                if( _elm( $aData, 'C_PERIDO_LIMIT' ) == 'N' ){
                                    $checked = true;
                                }
                                $setParam = [
                                    'name' => 'i_period_limit',
                    ...
                    <!-- <div class="input-group" id="dupCpnArea" <?php echo _elm( $aData, 'C_IS_SUPER_FLAG' ) == 'Y' || _elm( $aData, 'C_PUB_GBN' ) == 'D' ? 'style="display:none"':'' ?>>
                        <label class="label body2-c">
                            사용옵션
                        </label>
                        <?php
                            $checked = false;
                            if( _elm( $aData, 'C_DUPLICATE_USE_FLAG' ) == 'Y' ){
                                $checked = true;
                            }
                            $setParam = [
                    ...
                    <div class="input-group" id="superCpnArea" <?php echo _elm( $aData, 'C_PUB_GBN' ) != 'P' ? 'style="display:none"':'' ?>>
                        <label class="label body2-c">
                            슈퍼쿠폰
                        </label>
                        <?php
                            $checked = false;
                            if( _elm( $aData, 'C_IS_SUPER_FLAG' ) == 'Y' ){
                                $checked = true;
                            }
                            $setParam = [
...
<?php
if( _elm( $aData, 'C_SCOPE_GBN' ) == 'all' ){
    $itemIdxs = explode( ',', _elm( $aData, 'C_EXCEPT_PRODUCT_IDXS' ) );
?>
exceptProductPickList = <?php echo json_encode( $itemIdxs );?>;
<?php
}
?>
...
<?php
if( _elm( $aData, 'C_SCOPE_GBN' ) == 'category' ){
    $itemIdxs = explode( ',', _elm( $aData, 'C_PICK_ITEMS' ) );
?>
preloadedCategories = <?php echo json_encode( $itemIdxs );?>;
<?php
}
?>
let   preloadedBrands = [];
<?php
if( _elm( $aData, 'C_SCOPE_GBN' ) == 'brand' ){
    $itemIdxs = explode( ',', _elm( $aData, 'C_PICK_ITEMS' ) );
?>
preloadedBrands = <?php echo json_encode( $itemIdxs );?>;
<?php
}
?>
...
<?php
if( _elm( $aData, 'C_SCOPE_GBN' ) == 'product' ){
    $itemIdxs = explode( ',', _elm( $aData, 'C_PICK_ITEMS' ) );
?>
addProductPickList = <?php echo json_encode( $itemIdxs );?>;
<?php
}
?>
...
function frmModify(){
    ...
    var scope_gbn = $('#frm_modify [name=i_scope_gbn]').val();
    ...
    // 폼 전송 로직 추가
    $.ajax({
        url: '/apis/promotion/couponModifyProc',
        method: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
