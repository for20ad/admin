...
namespace Module\comm\chat\Controllers;
...
class Chat extends ApiController
{
    ...
    public function sendMessage() {
        ...
        $modelParam['message']                     = htmlspecialchars( _elm( $requests, 'message' ), ENT_QUOTES, 'UTF-8');
        ...
        $aResult                                   = $this->chatService->addMessage($modelParam);
    ...
    public function getMessages()
    {
        ...
        $messages                                  = $this->chatService->getMessages($room_id, $since);
    ...
    public function addRoom( $param = [] )
    {
        ...
        $aResult                                   = $this->chatService->addRoom( $modelParam );
    ...
    public function getRoomLists()
    {
        ...
        $room_lists                                = $this->chatService->getMyRoomLists( $modelParam );


        $response['data']                          = $room_lists;
    ...
    public function getRoomInfo( $param = [] )
    {
        ...
        $room_info                                 = $this->chatService->getRoomInfo( _elm( $requests, 'room_id' ) );
