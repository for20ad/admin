                                    ...
                                    ?>
                                        <div class="input-group required" style="max-width:100%">
                                            ...
                                            <?php
                                                ...
                                                $selected = _elm( $pGroup, 'D_MB_GOURP_DC_UNIT' );
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-vcenter" id="aGroupGoodsTable">
                                            ...
                                            <tr data-idx="<?php echo _elm( $gLists , 'G_IDX' )?>" onmouseover="$(this).find('.group-move-icons').show()" onmouseout="$(this).find('.group-move-icons').hide()">
                                                ...
                                                <td class="body2-c nowrap"><a href="javascript:window.open('<?php echo _link_url('/goods/goodsDetail/'._elm( $gLists , 'G_IDX' ) )?>', '_blank');" ><?php echo  _elm( $gLists , 'G_NAME' )?></a></td>
...
async function frmModify(e) {
    ...
    $.ajax({
        url: '/apis/goods/goodsDetailProc',
        method: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
