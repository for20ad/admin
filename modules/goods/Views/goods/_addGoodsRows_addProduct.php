...
<tr data-idx="<?php echo _elm( $vData , 'G_IDX' )?>" onmouseover="$(this).find('.add-move-icons').show()" onmouseout="$(this).find('.add-move-icons').hide()">
    <input type="hidden" name="i_add_goods_idxs[]" value="<?php echo _elm( $vData , 'G_IDX' )?>">
    <td>
    ...
    <td class="body2-c nowrap">
        ...
        <?php
            $setParam = [
                ...
                'id' => 'i_add_goods_idxs_'._elm( $vData, 'G_IDX'),
    ...
    <td class="body2-c nowrap"><img src="/<?php echo _elm( $vData, 'I_IMG_PATH' )?>" width="60" class="icon-image" ></td>
