<?php
    ...
    $brandOptions     = _elm($pageDatas, 'brandOption', '');
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter">
                            <tbody>
                                ...
                                <tr>
                                    <th class="no-border-bottom">별점</th>
                                    <td colspan="3" class="no-border-bottom">
                                    <?php
                                        $options  = [''=>'별점수','1'=>'★', '2'=>'★★', '3'=>'★★★', '4'=>'★★★★', '5'=>'★★★★★'];
                                        $extras   = ['id' => 's_star', 'class' => 'form-select', 'style' => 'max-width: 150px;', ];
                                        $selected = '';
                                        echo getSelectBox('s_star', $options, $selected, $extras);
                                    ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3" class="no-border-bottom">
                                        <div class="form-inline">
                                            <?php
                                                $options  = ['goods_name'=>'상품명','goods_code'=>'상품코드', 'goods_no'=>'상품번호'];
                                ...
                                <tr>
                                    ...
                                    <td class="no-border-bottom"><?php echo $brandOptions?></td>
                                    <th class="no-border-bottom">판매가</th>
                                    <td class="no-border-bottom">
                                        <div class="form-inline">
                                            <input type="text" class="form-control" style="width:10.2rem" name="s_price_start" id="s_price_start" numberwithcomma> 이상
                                            ~
                                            <input type="text" class="form-control" style="width:10.2rem" name="s_price_end" id="s_price_end" numberwithcomma> 이하
                                        </div>
