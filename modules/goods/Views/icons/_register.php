        ...
        <div class="card">
            <div class="card-body">
                <div class="input-group required">
                    ...
                    <input type="text" class="form-control" placeholder="아이콘 이름을 입력하세요." name="i_name" id="i_name" data-max-length="30" style="border-top-right-radius:0px; border-bottom-right-radius: 0px" value=""/>
                ...
                <div class="input-group required">
                    ...
                    <input type="text" class="form-control" placeholder="자동생성됩니다." name="i_code" id="i_code" style="border-top-right-radius:0px; border-bottom-right-radius: 0px" value="" readonly/>
                </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="input-group">
                    <label class="label body2-c" style="max-width:10.9557rem; border:1px solid #e6e7e9;border-radius:4px; height:2.2rem;margin-right:1.3rem;">
