                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter">
                            <tbody>
                                ...
                                <tr>
                                    <th class="no-border-bottom">아이콘 이름</th>
                                    <td colspan="3" class="no-border-bottom">
                                        <input type="text" class="form-control" style="width:15.2rem" name="s_icon_name" id="s_icon_name">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th class="no-border-bottom">기간제한 상태</th>
...
<?php
$owensView->setFooterJs('/assets/js/goods/icons/lists.js');
$owensView->setFooterJs('/assets/js/goods/icons/register.js');
$owensView->setFooterJs('/assets/js/goods/icons/detail.js');
