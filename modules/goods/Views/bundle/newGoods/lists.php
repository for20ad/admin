<?php
    ...
    $aProductLists    = _elm( $pageDatas, 'productLists', [] );
...
<div class="container-fluid">
    ...
    <div class="card-title">
        <h3 class="h3-c">newArrival 상품</h3>
    </div>
</div>
...
$('#newGoodsSort').sortable({
    handle: '.group-move-icons',
    update: function(event, ui) {
        var idsInOrder = $('#newGoodsSort').sortable('toArray',{ attribute : 'data-idx'});

        console.log(idsInOrder);
        $('#newGoodsSort tr').each(function(index) {
...
function frmRegister() {
    ...
    $.ajax({
        url: '/apis/goods/newGoodsRegister',
        method: 'POST',
        data: formData,
        dataType: 'json',
        processData: false,
...
<!-- Form List Modal E-->
<?php
$owensView->setFooterJs('/assets/js/goods/bundle/best/lists.js');
