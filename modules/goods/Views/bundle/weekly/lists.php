...
function openLayer( i_idx, id ){
    let data = '';
    let url  = '/apis/goods/weeklyGoodsRegister';

    if( i_idx != '' ){

        data = 'i_idx='+i_idx;
        url  = '/apis/goods/weeklyGoodsDetail';
    }
    $.ajax({
        url: url,
        type: 'post',
...
<?php
$owensView->setFooterJs('/assets/js/goods/bundle/weekly/lists.js');
$owensView->setFooterJs('/assets/js/goods/bundle/weekly/register.js');
$owensView->setFooterJs('/assets/js/goods/bundle/weekly/detail.js');
