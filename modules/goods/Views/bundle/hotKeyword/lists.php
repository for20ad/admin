                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter">
                            <tbody>
                                ...
                                <tr>
                                    <th class="no-border-bottom">키워드</th>
...
$('#tableSort').sortable({
    ...
    update: function(event, ui) {
        ...
        updateHotKeywordSort(idsInOrder);
...
function updateHotKeywordSort()
{
    ...
    $.ajax({
        url: "/apis/goods/updateHotKeywordSort",
        type: 'post',
        data: s_data,
        dataType: 'json',
        processData:false,
...
function openLayer( i_idx, id ){
    let data = '';
    let url  = '/apis/goods/hotKeywordRegister';

    if( i_idx != '' ){

        data = 'i_idx='+i_idx;
        url  = '/apis/goods/hotKeywordDetail';
    }
    $.ajax({
        url: url,
        type: 'post',
...
<?php
$owensView->setFooterJs('/assets/js/goods/bundle/hotKeyword/lists.js');
$owensView->setFooterJs('/assets/js/goods/bundle/hotKeyword/register.js');
$owensView->setFooterJs('/assets/js/goods/bundle/hotKeyword/detail.js');
