                    ...
                    <div class="form-inline">
                        <div class="input-icon">
                            <input type="text" class="form-control  datepicker-icon flatpickr-input"
                                name="i_start_date" id="i_start_date" value="<?php echo _elm( $aData, 'A_PERIOD_START_AT' ) != '0000-00-00' ? date( 'Y-m-d H:i', strtotime( _elm( $aData, 'A_PERIOD_START_AT' ) ) ) : ''?>" readonly>
                        ...
                        <div class="input-icon">
                            <input type="text" class="form-control  datepicker-icon flatpickr-input"
                                name="i_end_date" id="i_end_date" value="<?php echo _elm( $aData, 'A_PERIOD_END_AT' )  != '0000-00-00' ? date( 'Y-m-d H:i', strtotime( _elm( $aData, 'A_PERIOD_END_AT' ) ) ) : ''?>" readonly>
                            <span class="input-icon-addon">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24"
                                    height="24" viewBox="0 0 24 24" stroke-width="2"
                                    stroke="currentColor" fill="none" stroke-linecap="round"
