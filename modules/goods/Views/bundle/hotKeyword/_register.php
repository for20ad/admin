        ...
        <div class="card">
            <div class="card-body">
                <div class="input-group required">
                    ...
                    <input type="text" class="form-control" placeholder="노출 키워드를 입력하세요." name="i_title" id="i_title" data-max-length="30" style="border-top-right-radius:0px; border-bottom-right-radius: 0px" value=""/>
