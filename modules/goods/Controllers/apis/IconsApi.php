...
class IconsApi extends ApiController
{
    ...
    public function iconRegisterProc()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '상품 아이콘 등록 - data:'.json_encode( $modelParam, JSON_UNESCAPED_UNICODE ) ;
    ...
    public function deleteIcons()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '상품 아이콘 삭제 - orgData:'.json_encode( $aData, JSON_UNESCAPED_UNICODE );
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
