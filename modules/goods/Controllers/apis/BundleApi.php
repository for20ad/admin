...
class BundleApi extends ApiController
{
    ...
    public function defaultGoodsRegister( $param = [] )
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '기본상품상품 저장 - data:'.json_encode( $requests, JSON_UNESCAPED_UNICODE ) ;
    ...
    public function bestGoodsRegister( $param = [] )
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '베스트상품 저장 - data:'.json_encode( $requests, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function newGoodsRegister( $param = [] )
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '최신상품 저장 - data:'.json_encode( $requests, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function timeSaleDetailProc()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '타임세일 데이터 수정 - org_data:'.json_encode( $aData, JSON_UNESCAPED_UNICODE ). "// newData:".json_encode( $modelParam, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function timeSaleRegisterProc()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '타임세일 데이터 등록 - data:'.json_encode( $modelParam, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function deleteTimeSale()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '타임세일 데이터 삭제 - data:'.json_encode( $aData, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function timeSaleDetailRegister( $param= [] )
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '타임세일 상품 저장 - data:'.json_encode( $requests, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function weeklyGoodsRegisterProc()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '주간상품 데이터 등록 - data:'.json_encode( $modelParam, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function weeklyGoodsDetailProc()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '주간상품 데이터 수정 - org_data:'.json_encode( $aData, JSON_UNESCAPED_UNICODE ). "// newData:".json_encode( $modelParam, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function weeklyGoodsDetailRegister( $param= [] )
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '주간상품 상품리스트 저장 - data:'.json_encode( $requests, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
    ...
    public function deleteWeeklyGoods()
    {
        ...
        #------------------------------------------------------------------
        $logParam                                   = [];
        $logParam['MB_HISTORY_CONTENT']             = '주간상품 데이터 삭제 - data:'.json_encode( $aData, JSON_UNESCAPED_UNICODE ) ;
        $logParam['MB_IDX']                         = _elm( $this->session->get('_memberInfo') , 'member_idx' );
