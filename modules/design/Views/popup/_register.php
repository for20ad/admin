...
<!-- <link href="/plugins/editors/summernote/summernote-lite-mod.css" rel="stylesheet">
<script src="/plugins/editors/summernote/summernote-lite.js"></script>
<script src="/plugins/editors/summernote/lang/summernote-ko-KR.js"></script>
<script src="/plugins/editors/summernote/summernote-image-attributes.js"></script>
<script src="/plugins/editors/summernote/lang/summernote-image-attributes-ko-KR.js"></script> -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="제목을 입력하세요." name="i_title" id="i_title" data-max-length="30"  value=""/>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="가로 사이즈를 입력하세요." name="i_width" id="i_width" value=""/>
                    <span class="wordCount input-group-text" style="border-top-left-radius:0px; border-bottom-left-radius: 0px">
                        px
                    </span>
                </div>
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" placeholder="세로 사이즈를 입력하세요." name="i_height" id="i_height" value=""/>
                    <span class="wordCount input-group-text" style="border-top-left-radius:0px; border-bottom-left-radius: 0px">
                        px
                    </span>
                </div>
