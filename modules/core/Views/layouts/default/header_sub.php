...
<header class="header-section">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <div class="header-logo"><a class="navbar-brand" href="/">임대 시스템</a></div>
            ...
            <div class="navbar-collapse collapse" id="navbarCollapse">
                <ul class="navbar-nav navbar-nav-scroll ms-auto">
                    <li class="nav-item"><a href="/"class="nav-link <?php echo ($requestUri == '') ? 'active' : ''; ?>"><i class="bi bi-house-door me-1"></i> 홈</a></li>
