<?php
    ...
    $orderTitle       = [
        ...
        'complate'           => '반품완료',
        'paycancel'          => '반품결제취소',
        'refoundRequest'     => '반품환불요청',
        'refoundComplate'    => '반품환불완료',
        'reject'             => '불가/철회',
    ];
    $orderBtns        = [
        'ReturnRequest'                             => '반품 요청',
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="s_ordStatus" id="s_ordStatus" value="PayComplete,RefundRequest,ShippingCancelRequest">
...
function openLayer(ordIdx, id) {
    ...
    data = 'ordIdx=' + ordIdx;
    url = '/apis/order/orderReturnsDetail';
    $.ajax({
        url: url,
        type: 'post',
        data: data,
...
<?php
$owensView->setFooterJs('/assets/js/order/returns/lists.js');
$owensView->setFooterJs('/assets/js/order/returns/register.js');
$owensView->setFooterJs('/assets/js/order/returns/detail.js');
