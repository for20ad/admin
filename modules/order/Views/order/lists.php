<?php
    ...
    $aOrderStatus     = _elm( $pageDatas, 'aOrderConf' );
?>
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" class="no-border-bottom">
                                        <div class="form-inline">
                                            <?php
                                                $options = ['orderNo'=>'주문번호', 'memberId'=>'회원아이디', 'memberName'=>'회원명','mobile'=>'휴대폰번호'];
        ...
        <div class="card-body">
            ...
            <div style="border:1px solid #E6E7E9; border-top: 0px; border-radius:0 0 4px 4px;">
                <div class="table-responsive order-table">
                    <table class="table table-vcenter" id="listsTable" style="overflow-x: scroll;  min-width: 800px; /* 최소 너비 설정 */">
                        <colgroup>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content" style="max-height:90vh;display:flex;flex-direction: column;width:100vh">
            <div class="modal-header">
                <h5 class="modal-title" id="dataModalLabel">주문상세정보</h5>
